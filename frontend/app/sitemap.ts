...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${site.url}/signup`, lastModified: updated, changeFrequency: "monthly", priority: 0.8 },
    { url: `${site.url}/login`, lastModified: updated, changeFrequency: "monthly", priority: 0.6 },
